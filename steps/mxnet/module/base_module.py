...
class BaseModule(object):
    ...
    def predict(self, eval_data, num_batch=None, merge_batches=True, reset=True,
                always_output_list=False, output_input_data_and_label=False):
        ...
        for nbatch, eval_batch in enumerate(eval_data):
            ...
            if output_input_data_and_label:
                outputs.extend([out[0:out.shape[0]-pad].copy() for out in eval_batch.data+eval_batch.label])
    ...
    def load_params(self, fname, allow_missing=False):
